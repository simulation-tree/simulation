...
#else
        private readonly delegate*<Simulator, Allocation, World, TimeSpan, StatusCode> function;

        public UpdateProgram(delegate*<Simulator, Allocation, World, TimeSpan, StatusCode> function)
        {
            this.function = function;
        }
#endif
