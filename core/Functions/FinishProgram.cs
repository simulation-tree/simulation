...
#else
        private readonly delegate*<Simulator, Allocation, World, ReturnCode, void> function;

        public FinishProgramFunction(delegate*<Simulator, Allocation, World, ReturnCode, void> function)
        {
            this.function = function;
        }
#endif
